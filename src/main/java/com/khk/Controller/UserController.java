...
//    }
	...
	public String paymentWithCheckoutPage(@RequestBody CheckoutPayment payment) throws StripeException {
		...
		System.out.println("response data id"+gson.toJson(responseData));
		System.out.println("session response"+session.getLastResponse());
		System.out.println("Session Param after session created::  "+params.getCustomerEmail());
	...
	public String setPaymentDetail(@RequestBody String email) {
		...
		String msg=paymentDeatailService.setPaymentDetail(paymentDetails);
	...
	public String changeStatus(@RequestBody User user) {
		String msg=service.changeStatus(user);
		return  msg;
	}
